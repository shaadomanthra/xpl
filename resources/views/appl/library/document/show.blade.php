    ...
    <div class="col-md-9">
      <div class="card  mb-3">
        <div class="card-body ">
          ...
          <a class="navbar-brand"><i class="fa fa-file-text-o"></i> {{ $document->name }} 
            </a>
        ...
        <div>
          <iframe src="https://docs.google.com/viewer?srcid={{ $document->document}}&pid=explorer&efh=false&a=v&chrome=false&embedded=true" width="100%" height="480px"></iframe>
         
        </div>
        <div class="badge badge-info">#{{$document->structure->name}}</div><br>
        
        @can('update',$document)
           <span class="btn-group mt-4" role="group" aria-label="Basic example">
              <a href="{{ route('document.edit',['repository'=>$repo->slug,'document'=>$document->id]) }}" class="btn btn-outline-primary" data-tooltip="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form method="post" action="{{route('document.destroy',['repository'=>$repo->slug,'document'=>$document->id])}}">
