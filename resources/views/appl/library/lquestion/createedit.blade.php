...
@include('flash::message')
  <div class="card">
    <div class="card-body">
      ...
      @if($stub=='Create')
      <form method="post" action="{{route('lquestion.store',$repo->slug)}}" >
      @else
      <form method="post" action="{{route('lquestion.update',[$repo->slug,$question->id])}}" >
      @endif  
    ...
    <div class="tab-content" id="myTabContent">
      ...
      <div class="tab-pane fade" id="answer" role="tabpanel" aria-labelledby="answer-tab">
         @include('appl.library.snippets.answer')
      ...
      <div class="tab-pane fade" id="passage" role="tabpanel" aria-labelledby="passage-tab">
        ...
        @include('appl.library.snippets.passage_attach')
       
      </div>
      <div class="tab-pane fade" id="category" role="tabpanel" aria-labelledby="category-tab">
        <div class="form-group mt-3">
          <div class="card mb-3 bg-light border">
            <div class="card-body">Structure</div>
          </div>
         @if($structures)
          <div class="dd">
          {!! $structures !!}
