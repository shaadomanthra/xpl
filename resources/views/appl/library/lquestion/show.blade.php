    ...
    <div class="col-md-9">
      ...
      <div class="card mb-3">
        <div class="card-body">
          ...
          <div class="passage mt-3" style="display: none;">
          {!! $lpassage->passage !!}
          </div>
        </div>
      </div>
     ...
     <div class="col-md-3 pl-md-0">
      @include('appl.library.snippets.qset')
      @include('appl.library.snippets.qdetails')
    </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form method="post" action="{{route('lquestion.destroy',['repo'=>$repo->slug,'question'=>$question->id])}}">
