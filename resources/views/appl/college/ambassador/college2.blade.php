...
<div class=" p-4  mb-3 mb-md-4 border-bottom bg-white">
	...
	<div class="row">
		<div class="col-12 col-md-10">
			...
			<i class="fa fa-university"></i> &nbsp; {{ $college->name }} - Campus Connect
			</h1>
      <p> <a href="{{ route('college.view',$college->id)}}"><i class="fa fa-angle-double-left"></i> back to college</a></p>
      <p>
              ...
              @foreach($branches as $k => $b)
                <div class="col-12 col-md-4 mb-4">
                  <div class="bg-light border rounded p-4">
                    <h2>{{ $k }}</h2>
                    <a href="{{ route('ambassador.students.view',$college->id)}}?branch={{$k}}"><div class="display-1">{{ $b}}</div></a>
                  </div>
                </div>
              @endforeach
