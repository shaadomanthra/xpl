...
<div class="mb-md-2">
	...
	@else
	  ...
	  @else
	  	<div class="card "  style="background: #fff4ef;border: 2px solid #ffdecc;color: #ab836e;">
				<div class="card-body">
				The coding question are submitted for evaluation. Kindly check back after 24 hours to know your result. <br>In case of any query, kindly contact the web administrator.
			</div>
		</div>
