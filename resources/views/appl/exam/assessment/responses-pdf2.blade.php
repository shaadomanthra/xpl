    ...
    <body>
        ...
        <main class="bcontainer">
          ...
          <div id="pdf" style="padding:20px ;">
            <img src="https://xplore.co.in/img/xplore.png" style="width:100px;border-radius: 10px;margin-bottom: 25px;"/>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    @else
                      ...
                      @else
                        @if($t->mark==0 && $t->question->type!='urq' && $t->question->type!='sq' && $t->question->type!='code')
