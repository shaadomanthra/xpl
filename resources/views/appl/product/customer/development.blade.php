...
<div class="row">
    ...
    <h2 class="mb-4">Training Curriculum </h2>
                ...
                <td> 
                	<p>
                		...
                		<ol>
                			...
                			<li> Syntax and Rules</li>
                			<li> Head Section, Meta tags, scripts, CSS, Elements, Attributes and Values</li>
                			<li> Div layouts, paragraph tags</li>
                			<li> Anchor links</li>
                			<li> Forms and validation</li>
                			<li> Video and audio files integration</li>
                		</ol>
                	</p> 
                	<p>
                		<h3>CSS 3 </h3>
                		<ol>
                			...
                			<li> Selectors - id, class, attributes</li>
                			<li> Properties - color, background, image, font, position and borders</li>
...
<div class="col-12 col-md-4">
	...
	<div class="bg-light p-2 rounded border mb-4"><h1> Know More</h1></div>
