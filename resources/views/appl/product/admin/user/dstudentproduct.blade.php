  ...
  <div class="card">
    <div class="card-body">
      ...
      <h1 class="">
       ...
       <p>Access to 200+ video lectures, 5000+ pactice questions and numerous online tests. <br>Courses included are Quantitative Aptitude, Logical Reasoning, Mental Ability, Interview Skills. <br>Package Valid for  3 months.</p>
     </div>
