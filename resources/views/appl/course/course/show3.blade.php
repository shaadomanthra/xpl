...
<div class="row mt-md-3" >
	...
	@if(\auth::user())
         ...
         <div class="card-body form-group ">
         	...
         	<hr>
			  ...
			  @endif
			  <hr>
			  <a href="{{ route('course.batches',$course->slug) }}" ><i class="fa fa-bar-chart"></i> View Batch Analytics</a>
			  </div>
  ...
  @endif
	...
	<div class="col-12 col-md-8 col-lg-8 mt-md-1">
		...
		@foreach($new_nodes as $name=>$n)
			<li class="item title-list" id="{{ $name }}" > <h3><span class="bg-light p-1 pr-3 pl-3 border rounded">{{++$j}}</span> &nbsp;{{ $name }}</h3>
