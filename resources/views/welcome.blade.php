...
<div class="container pt-3">
    ...
    <h2 class="heading3 text-white " >Best platform to prepare for</h2>
    <h1 class="heading1 text-white mt-2 mb-1" >Campus Placements</h1>
    <h4 class="heading4 text-white mb-5" style="line-height: 30px;" >Quantitative Aptitude, Reasoning, Verbal Ability, Programming Concepts and Coding</h4>
