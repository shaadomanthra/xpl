...
<form class="form-horizontal" method="POST" action="{{ route('register.client') }}">
    ...
    <label class="form-check-label" for="exampleCheck1">I have read the <a href="{{url('/').'/files/terms_and_conditions_for_EAMCET_mock_test.pdf'}}" target="_blank">Terms and Conditions </a></label>
  </div>
