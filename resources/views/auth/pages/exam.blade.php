        ...
        <div class="col-12 col-md-4">
         ...
         <div class="col-12 col-md-4">
            <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                <label for="gender" class="col-md-8 control-label">Father Profession</label>

                <div class="col-md-12">
                    <input id="gender" type="text" class="form-control" name="fluency" value="{{ old('fluency') }}" required autofocus>
         ...
         <div class="col-12 col-md-4">
            <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                ...
                <div class="col-md-12">
                    ...
                    <input id="fluency" type="text" class="form-control" name="gender" value="{{ old('gender') }}" >
