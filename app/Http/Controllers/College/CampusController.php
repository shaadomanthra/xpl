    ...
    public function test_analytics($exam_slug,Request $r){
        ...
        if($r->get('batch')&& !$r->get('batch_code')){
            ...
            if($college)
                ...
                $branches = Branch::whereIn('name',['CSE','ECE','EEE','IT','CIVIL','MECH','CSW','CSO','CSM','CSIT','AI','CS','Data_Science','OTHER'])->get();
        ...
        $branches = array(1=>"BCOM",2=>"",3=>"",4=>"",5=>"",6=>"",7=>"",8=>"",9=>"CSE",10=>"IT",11=>"ECE",12=>"EEE",13=>"MECH",14=>"CIVIL",15=>"OTHER",60=>"CSW",61=>"CSO",69=>"CSM",47=>"CSIT",41=>"AI",74=>"Data_Science",22=>"CS");
        if(!$college)
