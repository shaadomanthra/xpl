...
return [
     ...
     *
     */
    'domain' => env('MAILGUN_DOMAIN', 'xplore.co.in'),

    /*
     * Mailgun (private) API key
     *
     */
    'api_key' => env('MAILGUN_PRIVATE', '43c0d0f72eef9f87f33fcb532b393899-f696beb4-1d8a819e'),

    /*
     * Mailgun public API key
     *
     */
    'public_api_key' => env('MAILGUN_PUBLIC', 'pubkey-2844adac3a5ce1d1d678b57fb7b02e62'),
     ...
     */
    'from' => [
        'address' => env('MAILGUN_FROM_ADDRESS', 'no-reply@xplore.co.in'),
        'name' => env('MAILGUN_FROM_NAME', 'Xplore'),
    ],
     ...
     *
     */
    'reply_to' => env('MAILGUN_REPLY_TO', 'info@xplore.co.in'),
