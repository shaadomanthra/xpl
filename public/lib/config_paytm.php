...
//define('PAYTM_MERCHANT_KEY', 'CIEeG3shkSK8w&2D'); //Change this constant's value with Merchant key downloaded from portal
//define('PAYTM_MERCHANT_MID', 'iiitjo82988793258057'); //Change this constant's value with MID (Merchant ID) received from Paytm
